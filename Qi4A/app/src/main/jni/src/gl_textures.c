...
cvar_t gl_max_lightmapsize = {CVAR_SAVE, "gl_max_lightmapsize", "1024",
...
cvar_t gl_picmip_other = {CVAR_SAVE, "gl_picmip_other", "0",
...
cvar_t gl_texturecompression = {CVAR_SAVE, "gl_texturecompression", "0",
...
cvar_t gl_texturecompression_color = {CVAR_SAVE, "gl_texturecompression_color", "1",
                                      "whether to compress colormap (diffuse) textures"};
cvar_t gl_texturecompression_normal = {CVAR_SAVE, "gl_texturecompression_normal", "0",
                                       "whether to compress normalmap (normalmap) textures"};
cvar_t gl_texturecompression_gloss = {CVAR_SAVE, "gl_texturecompression_gloss", "1",
                                      "whether to compress glossmap (specular) textures"};
cvar_t gl_texturecompression_glow = {CVAR_SAVE, "gl_texturecompression_glow", "1",
                                     "whether to compress glowmap (luma) textures"};
cvar_t gl_texturecompression_2d = {CVAR_SAVE, "gl_texturecompression_2d", "0",
                                   "whether to compress 2d (hud/menu) textures other than the font"};
cvar_t gl_texturecompression_q3bsplightmaps = {CVAR_SAVE, "gl_texturecompression_q3bsplightmaps",
                                               "0",
                                               "whether to compress lightmaps in q3bsp format levels"};
cvar_t gl_texturecompression_q3bspdeluxemaps = {CVAR_SAVE, "gl_texturecompression_q3bspdeluxemaps",
                                                "0",
                                                "whether to compress deluxemaps in q3bsp format levels (only levels compiled with q3map2 -deluxe have these)"};
cvar_t gl_texturecompression_sky = {CVAR_SAVE, "gl_texturecompression_sky", "0",
                                    "whether to compress sky textures"};
cvar_t gl_texturecompression_lightcubemaps = {CVAR_SAVE, "gl_texturecompression_lightcubemaps", "1",
                                              "whether to compress light cubemaps (spotlights and other light projection images)"};
cvar_t gl_texturecompression_reflectmask = {CVAR_SAVE, "gl_texturecompression_reflectmask", "1",
                                            "whether to compress reflection cubemap masks (mask of which areas of the texture should reflect the generic shiny cubemap)"};
cvar_t gl_texturecompression_sprites = {CVAR_SAVE, "gl_texturecompression_sprites", "1",
                                        "whether to compress sprites"};
cvar_t gl_nopartialtextureupdates = {CVAR_SAVE, "gl_nopartialtextureupdates", "0",
                                     "use alternate path for dynamic lightmap updates that avoids a possibly slow code path in the driver"};
cvar_t r_texture_dds_load_alphamode = {0, "r_texture_dds_load_alphamode", "1",
                                       "0: trust DDPF_ALPHAPIXELS flag, 1: texture format and brute force search if ambiguous, 2: texture format only"};
cvar_t r_texture_dds_load_logfailure = {0, "r_texture_dds_load_logfailure", "0",
                                        "log missing DDS textures to ddstexturefailures.log, 0: done log, 1: log with no optional textures (_norm, glow etc.). 2: log all"};
cvar_t r_texture_dds_swdecode = {0, "r_texture_dds_swdecode", "0",
...
static textypeinfo_t textype_shadowmap16_comp = {"shadowmap16_comp", TEXTYPE_SHADOWMAP16_COMP, 2, 2,
                                                 2.0f, GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT16,
                                                 GL_UNSIGNED_SHORT};
static textypeinfo_t textype_shadowmap16_raw = {"shadowmap16_raw", TEXTYPE_SHADOWMAP16_RAW, 2, 2,
                                                2.0f, GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT16,
                                                GL_UNSIGNED_SHORT};
static textypeinfo_t textype_shadowmap24_comp = {"shadowmap24_comp", TEXTYPE_SHADOWMAP24_COMP, 4, 4,
                                                 4.0f, GL_DEPTH_COMPONENT24_OES,
                                                 GL_DEPTH_COMPONENT24_OES, GL_UNSIGNED_SHORT};
static textypeinfo_t textype_shadowmap24_raw = {"shadowmap24_raw", TEXTYPE_SHADOWMAP24_RAW, 4, 4,
                                                4.0f, GL_DEPTH_COMPONENT24_OES,
                                                GL_DEPTH_COMPONENT24_OES, GL_UNSIGNED_SHORT};
static textypeinfo_t textype_depth16 = {"depth16", TEXTYPE_DEPTHBUFFER16, 2, 2, 2.0f,
                                        GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT16,
                                        GL_UNSIGNED_SHORT};
static textypeinfo_t textype_depth24 = {"depth24", TEXTYPE_DEPTHBUFFER24, 4, 4, 4.0f,
                                        GL_DEPTH_COMPONENT24_OES, GL_DEPTH_COMPONENT24_OES,
                                        GL_UNSIGNED_SHORT};
static textypeinfo_t textype_depth24stencil8 = {"depth24stencil8", TEXTYPE_DEPTHBUFFER24STENCIL8, 2,
                                                2, 2.0f, GL_DEPTH_COMPONENT, GL_DEPTH_COMPONENT,
                                                GL_UNSIGNED_SHORT};
static textypeinfo_t textype_colorbuffer_32 = {"colorbuffer", TEXTYPE_COLORBUFFER, 4, 4, 4.0f,
                                               GL_RGBA, GL_RGBA, GL_UNSIGNED_BYTE};
static textypeinfo_t textype_colorbuffer16f_32 = {"colorbuffer16f", TEXTYPE_COLORBUFFER16F, 4, 4,
                                                  4.0f, GL_RGBA, GL_RGBA, GL_UNSIGNED_BYTE};
static textypeinfo_t textype_colorbuffer32f_32 = {"colorbuffer32f", TEXTYPE_COLORBUFFER32F, 4, 4,
                                                  4.0f, GL_RGBA, GL_RGBA, GL_UNSIGNED_BYTE};

static textypeinfo_t textype_colorbuffer_16 = {"colorbuffer", TEXTYPE_COLORBUFFER, 2, 2, 2.0f,
                                               GL_RGB, GL_RGB, GL_UNSIGNED_SHORT_5_6_5};
static textypeinfo_t textype_colorbuffer16f_16 = {"colorbuffer16f", TEXTYPE_COLORBUFFER16F, 2, 2,
                                                  2.0f, GL_RGB, GL_RGB, GL_UNSIGNED_SHORT_5_6_5};
static textypeinfo_t textype_colorbuffer32f_16 = {"colorbuffer32f", TEXTYPE_COLORBUFFER32F, 2, 2,
                                                  2.0f, GL_RGB, GL_RGB, GL_UNSIGNED_SHORT_5_6_5};

// image formats:
static textypeinfo_t textype_alpha = {"alpha", TEXTYPE_ALPHA, 1, 4, 4.0f, GL_ALPHA, GL_ALPHA,
                                      GL_UNSIGNED_BYTE};
static textypeinfo_t textype_palette = {"palette", TEXTYPE_PALETTE, 1, 4, 4.0f, GL_RGBA, GL_BGRA,
                                        GL_UNSIGNED_BYTE};
static textypeinfo_t textype_palette_alpha = {"palette_alpha", TEXTYPE_PALETTE, 1, 4, 4.0f, GL_RGBA,
                                              GL_BGRA, GL_UNSIGNED_BYTE};
static textypeinfo_t textype_rgba = {"rgba", TEXTYPE_RGBA, 4, 4, 4.0f, GL_RGBA, GL_RGBA,
                                     GL_UNSIGNED_BYTE};
static textypeinfo_t textype_rgba_alpha = {"rgba_alpha", TEXTYPE_RGBA, 4, 4, 4.0f, GL_RGBA, GL_RGBA,
                                           GL_UNSIGNED_BYTE};
static textypeinfo_t textype_bgra = {"bgra", TEXTYPE_BGRA, 4, 4, 4.0f, GL_RGBA, GL_BGRA,
                                     GL_UNSIGNED_BYTE};
static textypeinfo_t textype_bgra_alpha = {"bgra_alpha", TEXTYPE_BGRA, 4, 4, 4.0f, GL_RGBA, GL_BGRA,
                                           GL_UNSIGNED_BYTE};
static textypeinfo_t textype_dxt1 = {"dxt1", TEXTYPE_DXT1, 4, 0, 0.5f,
                                     GL_COMPRESSED_RGB_S3TC_DXT1_EXT, 0, 0};
static textypeinfo_t textype_dxt1a = {"dxt1a", TEXTYPE_DXT1A, 4, 0, 0.5f,
                                      GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, 0, 0};
static textypeinfo_t textype_dxt3 = {"dxt3", TEXTYPE_DXT3, 4, 0, 1.0f,
                                     GL_COMPRESSED_RGBA_S3TC_DXT3_EXT, 0, 0};
static textypeinfo_t textype_dxt5 = {"dxt5", TEXTYPE_DXT5, 4, 0, 1.0f,
...
static int gltexturetypeenums[GLTEXTURETYPE_TOTAL] = {GL_TEXTURE_2D, GL_TEXTURE_3D,
                                                      GL_TEXTURE_CUBE_MAP};
...
static textypeinfo_t *R_GetTexTypeInfo(textype_t textype, int flags) {
    switch (textype) {
        ...
        case TEXTYPE_RGBA:
            return /*((flags & TEXF_COMPRESS) && vid.support.ext_texture_compression_s3tc) ? ((flags & TEXF_ALPHA) ? &textype_rgba_alpha_compress : &textype_rgba_compress) : */((flags &
                                                                                                                                                                                  TEXF_ALPHA)
                                                                                                                                                                                 ? &textype_rgba_alpha
                                                                                                                                                                                 : &textype_rgba);
        case TEXTYPE_BGRA:
            return /*((flags & TEXF_COMPRESS) && vid.support.ext_texture_compression_s3tc) ? ((flags & TEXF_ALPHA) ? &textype_bgra_alpha_compress : &textype_bgra_compress) : */((flags &
                                                                                                                                                                                  TEXF_ALPHA)
                                                                                                                                                                                 ? &textype_bgra_alpha
                                                                                                                                                                                 : &textype_bgra);
        case TEXTYPE_ALPHA:
        ...
        case TEXTYPE_COLORBUFFER:
            return (is32bit) ? &textype_colorbuffer_32 : &textype_colorbuffer_16;
        case TEXTYPE_COLORBUFFER16F:
            return (is32bit) ? &textype_colorbuffer16f_32 : &textype_colorbuffer16f_16;
        case TEXTYPE_COLORBUFFER32F:
            return (is32bit) ? &textype_colorbuffer32f_32 : &textype_colorbuffer32f_16;
        case TEXTYPE_DEPTHBUFFER16:
            return &textype_depth16;
        case TEXTYPE_DEPTHBUFFER24:
            return &textype_depth24;
        case TEXTYPE_DEPTHBUFFER24STENCIL8:
            return &textype_depth24stencil8;
        case TEXTYPE_SHADOWMAP16_COMP:
            return &textype_shadowmap16_comp;
        case TEXTYPE_SHADOWMAP16_RAW:
            return &textype_shadowmap16_raw;
        case TEXTYPE_SHADOWMAP24_COMP:
            return &textype_shadowmap24_comp;
        case TEXTYPE_SHADOWMAP24_RAW:
            return &textype_shadowmap24_raw;
...
void R_FreeTexture(rtexture_t *rt) {
    ...
    for (gltpointer = &glt->pool->gltchain;
         *gltpointer && *gltpointer != glt; gltpointer = &(*gltpointer)->chain);
    if (*gltpointer == glt)
...
//			qglDeleteRenderbuffers(1, (GLuint *)&glt->renderbuffernum);CHECKGLERROR
                qglDeleteRenderbuffersEXT(1, (GLuint *) &glt->renderbuffernum);
                CHECKGLERROR
            }
            break;
...
void R_FreeTexturePool(rtexturepool_t **rtexturepool) {
    ...
    *rtexturepool = NULL;
    ...
    for (poolpointer = &gltexturepoolchain;
         *poolpointer && *poolpointer != pool; poolpointer = &(*poolpointer)->next);
    if (*poolpointer == pool)
    ...
    switch (vid.renderpath) {
        ...
        CHECKGLERROR
            ...
            for (pool = gltexturepoolchain; pool; pool = pool->next) {
                for (glt = pool->gltchain; glt; glt = glt->chain) {
                    ...
                    if (glt->texnum && (gl_filter_force ||
                                        !(glt->flags & (TEXF_FORCENEAREST | TEXF_FORCELINEAR)))) {
                        oldbindtexnum = R_Mesh_TexBound(0, gltexturetypeenums[glt->texturetype]);
                        qglBindTexture(gltexturetypeenums[glt->texturetype], glt->texnum);
                        CHECKGLERROR
                        if (glt->flags & TEXF_MIPMAP) {
                            qglTexParameteri(gltexturetypeenums[glt->texturetype],
                                             GL_TEXTURE_MIN_FILTER, gl_filter_min);
                            CHECKGLERROR
                        } else {
                            qglTexParameteri(gltexturetypeenums[glt->texturetype],
                                             GL_TEXTURE_MIN_FILTER, gl_filter_mag);
                            CHECKGLERROR
                        }
                        qglTexParameteri(gltexturetypeenums[glt->texturetype],
                                         GL_TEXTURE_MAG_FILTER, gl_filter_mag);
                        CHECKGLERROR
        ...
        case RENDERPATH_SOFT:
            ...
            for (pool = gltexturepoolchain; pool; pool = pool->next)
                for (glt = pool->gltchain; glt; glt = glt->chain)
                    if (glt->texnum &&
                        (gl_filter_force || !(glt->flags & (TEXF_FORCENEAREST | TEXF_FORCELINEAR))))
                        DPSOFTRAST_Texture_Filter(glt->texnum, (glt->flags & TEXF_MIPMAP)
                                                               ? dpsoftrast_filter_mipmap
                                                               : dpsoftrast_filter_nomipmap);
            break;
    }
}

static void
GL_Texture_CalcImageSize(int texturetype, int flags, int miplevel, int inwidth, int inheight,
                         int indepth, int *outwidth, int *outheight, int *outdepth,
                         int *outmiplevels) {
...
static int R_CalcTexelDataSize(gltexture_t *glt) {
    ...
    GL_Texture_CalcImageSize(glt->texturetype, glt->flags, glt->miplevel, glt->inputwidth,
                             glt->inputheight, glt->inputdepth, &width2, &height2, &depth2, NULL);
...
void R_TextureStats_Print(qboolean printeach, qboolean printpool, qboolean printtotal) {
    ...
    for (pool = gltexturepoolchain; pool; pool = pool->next) {
        ...
        for (glt = pool->gltchain; glt; glt = glt->chain) {
            ...
            isloaded = glt->texnum != 0 || glt->renderbuffernum != 0 || glt->d3dtexture ||
                       glt->d3dsurface;
            pooltotal++;
            pooltotalt += glsize;
            ...
            if (printeach)
                Con_Printf("%c%4i%c%c%4i%c %-24s %s %s %s %s\n", isloaded ? '[' : ' ',
                           ...
                           glt->inputtexels ? '[' : ' ', (glt->inputdatasize + 1023) / 1024,
                           glt->inputtexels ? ']' : ' ', glt->textype->name,
                           isloaded ? "loaded" : "      ",
                           (glt->flags & TEXF_MIPMAP) ? "mip" : "   ",
                           (glt->flags & TEXF_ALPHA) ? "alpha" : "     ", glt->identifier);
        }
        if (printpool)
            Con_Printf(
                    "texturepool %10p total: %i (%.3fMB, %.3fMB original), uploaded %i (%.3fMB, %.3fMB original), upload on demand %i (%.3fMB, %.3fMB original)\n",
                    (void *) pool, pooltotal, pooltotalt / 1048576.0, pooltotalp / 1048576.0,
                    poolloaded, poolloadedt / 1048576.0, poolloadedp / 1048576.0,
                    pooltotal - poolloaded, (pooltotalt - poolloadedt) / 1048576.0,
                    (pooltotalp - poolloadedp) / 1048576.0);
        sumtotal += pooltotal;
    ...
    if (printtotal)
        Con_Printf(
                ...
                sumtotal, sumtotalt / 1048576.0, sumtotalp / 1048576.0, sumloaded,
                sumloadedt / 1048576.0, sumloadedp / 1048576.0, sumtotal - sumloaded,
                (sumtotalt - sumloadedt) / 1048576.0, (sumtotalp - sumloadedp) / 1048576.0);
}
...
void R_Textures_Init(void) {
    ...
    R_RegisterModule("R_Textures", r_textures_start, r_textures_shutdown, r_textures_newmap,
                     r_textures_devicelost, r_textures_devicerestored);
}
                ...
                for (pool = gltexturepoolchain; pool; pool = pool->next) {
                    for (glt = pool->gltchain; glt; glt = glt->chain) {
                        ...
                        if (glt->texnum && (glt->flags & TEXF_MIPMAP) == TEXF_MIPMAP) {
                            oldbindtexnum = R_Mesh_TexBound(0,
                                                            gltexturetypeenums[glt->texturetype]);

                            qglBindTexture(gltexturetypeenums[glt->texturetype], glt->texnum);
                            CHECKGLERROR
                            qglTexParameteri(gltexturetypeenums[glt->texturetype],
                                             GL_TEXTURE_MAX_ANISOTROPY_EXT, old_aniso);
                            CHECKGLERROR
...
static void GL_SetupTextureParameters(int flags, textype_t textype, int texturetype) {
    ...
    if (vid.support.ext_texture_filter_anisotropic && (flags & TEXF_MIPMAP)) {
        ...
        qglTexParameteri(textureenum, GL_TEXTURE_MAX_ANISOTROPY_EXT, aniso);
        CHECKGLERROR
    }
    ...
    if (!gl_filter_force && flags & TEXF_FORCENEAREST) {
        ...
        if (flags & TEXF_MIPMAP) {
            if (gl_filter_min == GL_NEAREST_MIPMAP_LINEAR ||
...
static void
R_UploadPartialTexture(gltexture_t *glt, const unsigned char *data, int fragx, int fragy, int fragz,
                       int fragwidth, int fragheight, int fragdepth) {
    if (data == NULL)
        Sys_Error("R_UploadPartialTexture \"%s\": partial update with NULL pixels",
                  glt->identifier);

    if (glt->texturetype != GLTEXTURETYPE_2D)
        Sys_Error("R_UploadPartialTexture \"%s\": partial update of type other than 2D",
                  glt->identifier);

    if (glt->textype->textype == TEXTYPE_PALETTE)
        Sys_Error("R_UploadPartialTexture \"%s\": partial update of paletted texture",
                  glt->identifier);

    if (glt->flags & (TEXF_MIPMAP | TEXF_PICMIP))
        Sys_Error(
                "R_UploadPartialTexture \"%s\": partial update not supported with MIPMAP or PICMIP flags",
                glt->identifier);

    if (glt->inputwidth != glt->tilewidth || glt->inputheight != glt->tileheight ||
        glt->tiledepth != 1)
        Sys_Error(
                "R_UploadPartialTexture \"%s\": partial update not supported with stretched or special textures",
                glt->identifier);
    ...
    switch (vid.renderpath) {
        ...
        case RENDERPATH_GLES2: {
            ...
            qglBindTexture(gltexturetypeenums[glt->texturetype], glt->texnum);
            CHECKGLERROR
            qglTexSubImage2D(GL_TEXTURE_2D, 0, fragx, fragy, fragwidth, fragheight, glt->glformat,
                             glt->gltype, data);
            CHECKGLERROR
            qglBindTexture(gltexturetypeenums[glt->texturetype], oldbindtexnum);
            CHECKGLERROR
        ...
        case RENDERPATH_D3D11:
            ...
            break;
        case RENDERPATH_SOFT:
            DPSOFTRAST_Texture_UpdatePartial(glt->texnum, 0, data, fragx, fragy, fragwidth,
                                             fragheight);
            break;
    }
}
...
static void R_UploadFullTexture(gltexture_t *glt, const unsigned char *data) {
    ...
    if (glt->texturetype != GLTEXTURETYPE_2D &&
        (glt->tilewidth != glt->inputwidth || glt->tileheight != glt->inputheight ||
         glt->tiledepth != glt->inputdepth))
...
//		prevbuffer = resizebuffer;
        ...
        if (glt->textype->textype == TEXTYPE_PALETTE) {
            ...
            Image_Copy8bitBGRA(prevbuffer, colorconvertbuffer,
                               glt->inputwidth * glt->inputheight * glt->inputdepth * glt->sides,
                               glt->palette);
        ...
        if (glt->inputwidth != width || glt->inputheight != height || glt->inputdepth != depth) {
            Image_Resample32(prevbuffer, glt->inputwidth, glt->inputheight, glt->inputdepth,
                             resizebuffer, width, height, depth, r_lerpimages.integer);
            prevbuffer = resizebuffer;
        }
        // apply mipmap reduction algorithm to get down to picmip/max_size
        while (width > glt->tilewidth || height > glt->tileheight || depth > glt->tiledepth) {
            Image_MipReduce32(prevbuffer, resizebuffer, &width, &height, &depth, glt->tilewidth,
                              glt->tileheight, glt->tiledepth);
            prevbuffer = resizebuffer;
        }
    }
        ...
        case RENDERPATH_GLES2:
                                                                                                                                        ...
                                                                                                                                        if (qglGetCompressedTexImageARB)
			{
                ...
                switch (glt->texturetype) {
                    case GLTEXTURETYPE_2D:
                        qglTexImage2D(GL_TEXTURE_2D, mip++, glt->glinternalformat, width, height, 0,
                                      glt->glformat, glt->gltype, prevbuffer);
                        CHECKGLERROR
                        if (glt->flags & TEXF_MIPMAP) {
                            while (width > 1 || height > 1 || depth > 1) {
                                Image_MipReduce32(prevbuffer, resizebuffer, &width, &height, &depth,
                                                  1, 1, 1);
                                prevbuffer = resizebuffer;
                                qglTexImage2D(GL_TEXTURE_2D, mip++, glt->glinternalformat, width,
                                              height, 0, glt->glformat, glt->gltype, prevbuffer);
                                CHECKGLERROR
                            }
                        }
                        break;
				...
				if (glt->flags & TEXF_MIPMAP)
				{
                    ...
                    case GLTEXTURETYPE_CUBEMAP:
                        ...
                        for (i = 0; i < 6; i++) {
                            ...
                            texturebuffer += glt->inputwidth * glt->inputheight * glt->inputdepth *
                                             glt->textype->inputbytesperpixel;
                            if (glt->inputwidth != width || glt->inputheight != height ||
                                glt->inputdepth != depth) {
                                Image_Resample32(prevbuffer, glt->inputwidth, glt->inputheight,
                                                 glt->inputdepth, resizebuffer, width, height,
                                                 depth, r_lerpimages.integer);
                                prevbuffer = resizebuffer;
                            }
                            // picmip/max_size
                            while (width > glt->tilewidth || height > glt->tileheight ||
                                   depth > glt->tiledepth) {
                                Image_MipReduce32(prevbuffer, resizebuffer, &width, &height, &depth,
                                                  glt->tilewidth, glt->tileheight, glt->tiledepth);
                                prevbuffer = resizebuffer;
                            }
                            mip = 0;
                            qglTexImage2D(cubemapside[i], mip++, glt->glinternalformat, width,
                                          height, 0, glt->glformat, glt->gltype, prevbuffer);
                            CHECKGLERROR
                            if (glt->flags & TEXF_MIPMAP) {
                                while (width > 1 || height > 1 || depth > 1) {
                                    Image_MipReduce32(prevbuffer, resizebuffer, &width, &height,
                                                      &depth, 1, 1, 1);
                                    prevbuffer = resizebuffer;
                                    qglTexImage2D(cubemapside[i], mip++, glt->glinternalformat,
                                                  width, height, 0, glt->glformat, glt->gltype,
                                                  prevbuffer);
                                    CHECKGLERROR
                                }
                            }
        ...
        case RENDERPATH_SOFT:
            switch (glt->texturetype) {
                ...
                case GLTEXTURETYPE_CUBEMAP:
                    if (glt->inputwidth != width || glt->inputheight != height ||
                        glt->inputdepth != depth) {
                        unsigned char *combinedbuffer = (unsigned char *) Mem_Alloc(tempmempool,
                                                                                    glt->tilewidth *
                                                                                    glt->tileheight *
                                                                                    glt->tiledepth *
                                                                                    glt->sides *
                        ...
                        for (i = 0; i < 6; i++) {
                            ...
                            memcpy(combinedbuffer +
                                   i * glt->tilewidth * glt->tileheight * glt->tiledepth *
                                   glt->bytesperpixel, prevbuffer,
                                   glt->tilewidth * glt->tileheight * glt->tiledepth *
                                   glt->bytesperpixel);
                        }
...
static rtexture_t *
R_SetupTexture(rtexturepool_t *rtexturepool, const char *identifier, int width, int height,
               int depth, int sides, int flags, int miplevel, textype_t textype, int texturetype,
               const unsigned char *data, const unsigned int *palette) {
    int i, size;
    gltexture_t *glt;
    ...
    switch (textype) {
        case TEXTYPE_RGBA:
            if (vid.forcetextype == TEXTYPE_BGRA) {
                swaprb = true;
                textype = TEXTYPE_BGRA;
            }
            break;
        case TEXTYPE_BGRA:
            if (vid.forcetextype == TEXTYPE_RGBA) {
                swaprb = true;
                textype = TEXTYPE_RGBA;
            }
            break;
        case TEXTYPE_SRGB_RGBA:
            if (vid.forcetextype == TEXTYPE_BGRA) {
                swaprb = true;
                textype = TEXTYPE_SRGB_BGRA;
            }
            break;
        case TEXTYPE_SRGB_BGRA:
            if (vid.forcetextype == TEXTYPE_RGBA) {
                swaprb = true;
                textype = TEXTYPE_SRGB_RGBA;
            }
            break;
        default:
            break;
    ...
    if (swaprb) {
        ...
        temppixels = (unsigned char *) Mem_Alloc(tempmempool, size);
        if (data)
            Image_CopyMux(temppixels, data, width, height * depth * sides, false, false, false, 4,
                          4, rgbaswapindices);
        data = temppixels;
    }
    ...
    if (!vid.support.ext_texture_srgb) {
        ...
        switch (textype) {
            ...
            case TEXTYPE_SRGB_PALETTE:
                textype = TEXTYPE_PALETTE;/*convertsRGB = true;*/break;
            case TEXTYPE_SRGB_RGBA:
                textype = TEXTYPE_RGBA;
                convertsRGB = true;
                break;
    ...
    if (size < 1) {
        Con_Printf("R_LoadTexture: bogus texture size (%dx%dx%dx%dbppx%dsides = %d bytes)\n", width,
                   height, depth, texinfo->inputbytesperpixel * 8, sides, size);
        return NULL;
    }
    ...
    glt->inputdepth = depth;
    glt->flags = flags;
    glt->miplevel = (miplevel < 0) ? R_PicmipForFlags(flags)
                                   : miplevel; // note: if miplevel is -1, we know the texture is in original size and we can picmip it normally
    glt->textype = texinfo;
    ...
    GL_Texture_CalcImageSize(glt->texturetype, glt->flags, glt->miplevel, glt->inputwidth,
                             glt->inputheight, glt->inputdepth, &glt->tilewidth, &glt->tileheight,
                             &glt->tiledepth, &glt->miplevels);
    ...
    switch (vid.renderpath) {
        ...
        case RENDERPATH_SOFT: {
            ...
            switch (textype) {
                case TEXTYPE_PALETTE:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_BGRA8;
                    break;
                case TEXTYPE_RGBA:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_RGBA8;
                    break;
                case TEXTYPE_BGRA:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_BGRA8;
                    break;
                case TEXTYPE_COLORBUFFER:
                    ...
                    break;
                case TEXTYPE_COLORBUFFER16F:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_RGBA16F;
                    break;
                case TEXTYPE_COLORBUFFER32F:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_RGBA32F;
                    break;
                case TEXTYPE_SHADOWMAP16_COMP:
                case TEXTYPE_SHADOWMAP16_RAW:
                case TEXTYPE_SHADOWMAP24_COMP:
                case TEXTYPE_SHADOWMAP24_RAW:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_DEPTH;
                    break;
                case TEXTYPE_DEPTHBUFFER16:
                case TEXTYPE_DEPTHBUFFER24:
                case TEXTYPE_DEPTHBUFFER24STENCIL8:
                    ...
                    break;
                case TEXTYPE_ALPHA:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_ALPHA8;
                    break;
                default:
                    Sys_Error(
                            "R_LoadTexture: unsupported texture type %i when picking DPSOFTRAST_TEXTURE_FLAGS",
                            (int) textype);
            }
            ...
            glt->texnum = DPSOFTRAST_Texture_New(tflags, glt->tilewidth, glt->tileheight,
                                                 glt->tiledepth);
        }
            break;
    }
    ...
    if ((glt->flags & TEXF_ALLOWUPDATES) && gl_nopartialtextureupdates.integer)
        glt->bufferpixels = (unsigned char *) Mem_Alloc(texturemempool,
                                                        glt->tilewidth * glt->tileheight *
                                                        glt->tiledepth * glt->sides *
                                                        glt->bytesperpixel);
...
rtexture_t *
R_LoadTexture2D(rtexturepool_t *rtexturepool, const char *identifier, int width, int height,
                const unsigned char *data, textype_t textype, int flags, int miplevel,
                const unsigned int *palette) {
    return R_SetupTexture(rtexturepool, identifier, width, height, 1, 1, flags, miplevel, textype,
                          GLTEXTURETYPE_2D, data, palette);
}

rtexture_t *
R_LoadTexture3D(rtexturepool_t *rtexturepool, const char *identifier, int width, int height,
                int depth, const unsigned char *data, textype_t textype, int flags, int miplevel,
                const unsigned int *palette) {
    return R_SetupTexture(rtexturepool, identifier, width, height, depth, 1, flags, miplevel,
                          textype, GLTEXTURETYPE_3D, data, palette);
}

rtexture_t *R_LoadTextureCubeMap(rtexturepool_t *rtexturepool, const char *identifier, int width,
                                 const unsigned char *data, textype_t textype, int flags,
                                 int miplevel, const unsigned int *palette) {
    return R_SetupTexture(rtexturepool, identifier, width, width, 1, 6, flags, miplevel, textype,
                          GLTEXTURETYPE_CUBEMAP, data, palette);
}

rtexture_t *
R_LoadTextureShadowMap2D(rtexturepool_t *rtexturepool, const char *identifier, int width,
                         int height, textype_t textype, qboolean filter) {
    return R_SetupTexture(rtexturepool, identifier, width, height, 1, 1,
                          TEXF_RENDERTARGET | TEXF_CLAMP |
                          (filter ? TEXF_FORCELINEAR : TEXF_FORCENEAREST), -1, textype,
                          GLTEXTURETYPE_2D, NULL, NULL);
}

rtexture_t *
R_LoadTextureRenderBuffer(rtexturepool_t *rtexturepool, const char *identifier, int width,
                          int height, textype_t textype) {
    gltexture_t *glt;
    gltexturepool_t *pool = (gltexturepool_t *) rtexturepool;
...
//		qglRenderbufferStorage(GL_RENDERBUFFER, glt->glinternalformat, glt->tilewidth, glt->tileheight);CHECKGLERROR
            qglGenRenderbuffersEXT(1, (GLuint *) &glt->renderbuffernum);
            CHECKGLERROR
            qglBindRenderbufferEXT(GL_RENDERBUFFER, glt->renderbuffernum);
            CHECKGLERROR
            qglRenderbufferStorageEXT(GL_RENDERBUFFER, glt->glinternalformat, glt->tilewidth,
                                      glt->tileheight);
            CHECKGLERROR
...
//            qglBindRenderbuffer(GL_RENDERBUFFER, 0);
        ...
        case RENDERPATH_SOFT: {
            ...
            switch (textype) {
                case TEXTYPE_COLORBUFFER:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_BGRA8 | DPSOFTRAST_TEXTURE_FLAG_USEALPHA |
                             DPSOFTRAST_TEXTURE_FLAG_CLAMPTOEDGE;
                    break;
                case TEXTYPE_COLORBUFFER16F:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_RGBA16F | DPSOFTRAST_TEXTURE_FLAG_USEALPHA |
                             DPSOFTRAST_TEXTURE_FLAG_CLAMPTOEDGE;
                    break;
                case TEXTYPE_COLORBUFFER32F:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_RGBA32F | DPSOFTRAST_TEXTURE_FLAG_USEALPHA |
                             DPSOFTRAST_TEXTURE_FLAG_CLAMPTOEDGE;
                    break;
                case TEXTYPE_DEPTHBUFFER16:
                case TEXTYPE_DEPTHBUFFER24:
                case TEXTYPE_DEPTHBUFFER24STENCIL8:
                    tflags = DPSOFTRAST_TEXTURE_FORMAT_DEPTH | DPSOFTRAST_TEXTURE_FLAG_CLAMPTOEDGE;
                    break;
                default:
                    Sys_Error(
                            "R_LoadTextureRenderbuffer: unsupported texture type %i when picking DPSOFTRAST_TEXTURE_FLAGS",
                            (int) textype);
            }
            glt->texnum = DPSOFTRAST_Texture_New(tflags, glt->tilewidth, glt->tileheight,
                                                 glt->tiledepth);
...
rtexture_t *
R_LoadTextureDDSFile(rtexturepool_t *rtexturepool, const char *filename, qboolean srgb, int flags,
                     qboolean *hasalphaflag, float *avgcolor, int miplevel,
                     qboolean optionaltexture) // DDS textures are opaque, so miplevel isn't a pointer but just seen as a hint
{
    ...
    if (!dds) {
        if (r_texture_dds_load_logfailure.integer &&
            (r_texture_dds_load_logfailure.integer >= 2 || !optionaltexture))
            Log_Printf("ddstexturefailures.log", "%s\n", filename);
        return NULL; // not found
    }

    if (ddsfilesize <= 128 || memcmp(dds, "DDS ", 4) ||
        ddssize < (unsigned int) BuffLittleLong(dds + 4) || BuffLittleLong(dds + 76) != 32) {
        Mem_Free(dds);
    ...
    if ((dds_format_flags & 0x40) && BuffLittleLong(dds + 88) == 32) {
        ...
        size = INTOVERFLOW_MUL(INTOVERFLOW_MUL(INTOVERFLOW_DIV(INTOVERFLOW_ADD(dds_width, 3), 4),
                                               INTOVERFLOW_DIV(INTOVERFLOW_ADD(dds_height, 3), 4)),
                               bytesperblock);
        if (INTOVERFLOW_ADD(128, size) > INTOVERFLOW_NORMALIZE(ddsfilesize)) {
            Mem_Free(dds);
        ...
        if (flags & TEXF_ALPHA) {
            if (r_texture_dds_load_alphamode.integer == 1) {
                ...
                for (i = 0; i < size; i += bytesperblock)
                    if (ddspixels[i + 0] + ddspixels[i + 1] * 256 <=
                        ddspixels[i + 2] + ddspixels[i + 3] * 256) {
    ...
    while (miplevel >= 1 && dds_miplevels >= 1) {
        if (mipwidth <= 1 && mipheight <= 1)
            break;
        mipsize = bytesperblock ? ((mipwidth + 3) / 4) * ((mipheight + 3) / 4) * bytesperblock :
    ...
    if (force_swdecode) {
        ...
        for (i = bytesperblock == 16 ? 8 : 0; i < (int) mipsize_total; i += bytesperblock, p += 4) {
            c = mippixels_start[i] + 256 * mippixels_start[i + 1] + 65536 * mippixels_start[i + 2] +
                16777216 * mippixels_start[i + 3];
    ...
    if (avgcolor) {
        ...
        if (bytesperblock) {
            for (i = bytesperblock == 16 ? 8 : 0; i < mipsize; i += bytesperblock) {
                c = mippixels[i] + 256 * mippixels[i + 1] + 65536 * mippixels[i + 2] +
                    16777216 * mippixels[i + 3];
        ...
        if (vid.support.ext_texture_srgb) {
            switch (textype) {
                case TEXTYPE_DXT1:
                    ...
                    break;
                case TEXTYPE_DXT1A:
                    textype = TEXTYPE_SRGB_DXT1A;
                    break;
                case TEXTYPE_DXT3:
                    textype = TEXTYPE_SRGB_DXT3;
                    break;
                case TEXTYPE_DXT5:
                    textype = TEXTYPE_SRGB_DXT5;
                    break;
                case TEXTYPE_RGBA:
                    textype = TEXTYPE_SRGB_RGBA;
                    break;
            ...
            switch (textype) {
                ...
                case TEXTYPE_DXT5: {
                    for (i = bytesperblock == 16 ? 8 : 0; i < mipsize_total; i += bytesperblock) {
                        ...
                        g = ((c0 >> 5) & 0x3F);
                        b = ((c0) & 0x1F);
                        r = floor(Image_LinearFloatFromsRGB(r * (255.0f / 31.0f)) * 31.0f +
                                  0.5f); // these multiplications here get combined with multiplications in Image_LinearFloatFromsRGB
                        g = floor(Image_LinearFloatFromsRGB(g * (255.0f / 63.0f)) * 63.0f +
                                  0.5f); // these multiplications here get combined with multiplications in Image_LinearFloatFromsRGB
                        b = floor(Image_LinearFloatFromsRGB(b * (255.0f / 31.0f)) * 31.0f +
                                  0.5f); // these multiplications here get combined with multiplications in Image_LinearFloatFromsRGB
                        c0new = (r << 11) | (g << 5) | b;
                    ...
                    break;
                case TEXTYPE_RGBA:
                    Image_MakeLinearColorsFromsRGB(mippixels, mippixels,
                                                   mipsize_total / bytesperblock);
                    break;
                default:
                    break;
            }
    ...
    switch (vid.renderpath) {
        ...
        case RENDERPATH_D3D11:
            ...
            break;
        case RENDERPATH_SOFT:
            glt->texnum = DPSOFTRAST_Texture_New(
                    ((glt->flags & TEXF_CLAMP) ? DPSOFTRAST_TEXTURE_FLAG_CLAMPTOEDGE : 0) |
                    (dds_miplevels > 1 ? DPSOFTRAST_TEXTURE_FLAG_MIPMAP : 0), glt->tilewidth,
                    glt->tileheight, glt->tiledepth);
            break;
    }
    ...
    for (mip = 0; mip <= dds_miplevels; mip++) // <= to include the not-counted "largest" miplevel
    {
        ...
        if (npothack) {
            ...
            if (upload_mipwidth != mipwidth || upload_mipheight != mipheight)
                ...
                // harmless
            {
                upload_mippixels = (unsigned char *) Mem_Alloc(tempmempool, 4 * upload_mipwidth *
                                                                            upload_mipheight);
                Image_Resample32(mippixels, mipwidth, mipheight, 1, upload_mippixels,
                                 upload_mipwidth, upload_mipheight, 1, r_lerpimages.integer);
            }
        }
        switch (vid.renderpath) {
            case RENDERPATH_GL11:
            ...
            case RENDERPATH_GLES2:
                if (bytesperblock) {
                    qglCompressedTexImage2DARB(GL_TEXTURE_2D, mip, glt->glinternalformat,
                                               upload_mipwidth, upload_mipheight, 0, mipsize,
                                               upload_mippixels);
                    CHECKGLERROR
                } else {
                    qglTexImage2D(GL_TEXTURE_2D, mip, glt->glinternalformat, upload_mipwidth,
                                  upload_mipheight, 0, glt->glformat, glt->gltype,
                                  upload_mippixels);
                    CHECKGLERROR
                }
                break;
...
void R_UpdateTexture(rtexture_t *rt, const unsigned char *data, int x, int y, int z, int width,
    ...
    } else if (x || y || z || width != glt->inputwidth || height != glt->inputheight ||
